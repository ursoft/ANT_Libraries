...
typedef struct
{
   ULONG ul_cfg_auth_timeout;
   ULONG ul_cfg_erase_timeout;
   ULONG ul_cfg_upload_request_timeout;
   ULONG ul_cfg_upload_response_timeout;
   ULONG ul_cfg_burst_check_timeout;
} ANTFS_CONFIG_PARAMETERS;
...
class ANTFSHostChannel : public ANTFSHostInterface, public DSIANTMessageProcessor
{
   private:
      ...
      ANTFS_CONFIG_PARAMETERS cfgParams;
